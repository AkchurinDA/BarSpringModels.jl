# Naming convention:
# NC    - Nodal coordinates
# EC    - Element connectivity
# BC    - Boundary conditions
# P̃     - Applied reference load vector
# iₘ    - Maximum number of increments
# jₘ    - Maximum number of iterations
...
function analyze(NC::Matrix{Float64}, EC::Vector{<:Element}, BC::Matrix{Float64}, P̃::Matrix{Float64}, iₘ::Integer, jₘ::Integer, ControlDOF::Integer, ControlFactor::Real, ϵ::Real)
    ...
    for i in 1:iₘ
        ...
        for j in 1:jₘ
            ...
            CurrentElementF = getCurrentElementF(CurrentElementK, CurrentElementΔ)
