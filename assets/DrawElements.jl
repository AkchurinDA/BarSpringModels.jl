...
@drawsvg begin
    ...
    @layer begin
        fontsize(15)
        text(L"$u_{x_i}, u_{y_i}, u_{z_i}$", Point(-100 + 10, -100 - 25), halign=:left, valign=:bottom)
        text(L"$u_{x_j}, u_{y_j}, u_{z_j}$", Point(+100 - 10, -100 - 25), halign=:right, valign=:bottom)
